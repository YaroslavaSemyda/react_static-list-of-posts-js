...
aut aut aut maxime quia temporibus ut omnis`}],Dc=(e,t,i)=>t.map(n=>({...n,user:e.find(a=>a.id===n.userId),comments:i.filter(a=>a.postId===n.id)})),jc=()=>{const e=Dc(Tc,Mc,Rc);return O.jsxs("div",{className:"App",children:[O.jsx("h1",{className:"App__title",children:"Posts"}),O.jsx(Lc,{posts:e})]})};em(document.getElementById("root")).render(O.jsx(jc,{}));
